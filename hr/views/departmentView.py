...
class DepartmentViewSet(generics.GenericAPIView, mixins.ListModelMixin, mixins.CreateModelMixin):
...
class DepartmentDetailView(generics.GenericAPIView, mixins.RetrieveModelMixin, mixins.UpdateModelMixin, mixins.DestroyModelMixin ):
    queryset = Department.objects.all().order_by('created')
    authentication_classes = [authentication.TokenAuthentication]
    serializer_class = DepartmentSerializer
